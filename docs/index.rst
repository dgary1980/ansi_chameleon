.. ansi_chameleon documentation master file, created by
   sphinx-quickstart on Wed Sep 14 22:19:28 2016.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

ansi_chameleon MySQL to PostgreSQL replica
=========================================================
...
ansi_chameleon is a replication tool from MySQL to PostgreSQL developed in  Python 3.3+
...
ansi_chameleon can pull the data from a cascading replica when the MySQL slave is configured with log-slave-updates.



`Documentation available at pgchameleon.org <http://www.pgchameleon.org/documents/index.html>`_

`Release available via pypi <https://pypi.python.org/pypi/ansi_chameleon/>`_
