...
__version__ = get_distribution('ansi_chameleon')
import argparse
from ansi_chameleon import replica_engine
...
config_help = """Specifies the configuration to use without the suffix yml. If  the parameter is omitted then ~/.ansi_chameleon/configuration/default.yml is used"""
...
version_help = """Displays ansi_chameleon's installed  version."""
...
parser = argparse.ArgumentParser(description='Command line for ansi_chameleon.',  add_help=True)
